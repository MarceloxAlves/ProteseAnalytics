package br.com.m2j.proteseanalytics.services;
...
/**
 * Created by Marcelo on 19/05/2018.
 */

public class BluetoothService extends Service {

    // GUI Components
    String  tagName =  "Service Blue";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mHandler = new Handler() {
            public void handleMessage(android.os.Message msg) {
                ...
                if (msg.what == CONNECTING_STATUS) {
                    if (msg.arg1 == 1)
                        Log.i(tagName,"Deu certo");
                    else
                        Log.i(tagName,"Conexão Faliu");
                }
            }
        };
        ...
        if (mBTArrayAdapter == null) {
            ...
            Log.i(tagName,"Status: não encontrado");
    ...
    private BluetoothSocket createBluetoothSocket(BluetoothDevice device) throws IOException {
        try {
            ...
            Log.e(tagName, "Could not create Insecure RFComm Connection", e);
        }
